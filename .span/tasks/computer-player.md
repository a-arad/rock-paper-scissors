# span Task: Implement Computer Player (ID: computer-player)

## Task Description
Create computer player module with random move generation
...
```
DELIVERABLES: utils/computerPlayer.js,tests/computerPlayer.test.js
