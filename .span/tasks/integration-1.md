# span Task: Connect frontend to API (ID: integration-1)

## Task Description
Integrate frontend with Flask backend using axios
...
**Required tasks:** backend-2, frontend-2
...
```
ESTIMATED_TURNS: 10
DELIVERABLES: api-client.js,data-handler.js
