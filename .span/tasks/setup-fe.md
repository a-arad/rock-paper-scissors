# span Task: Initialize React Frontend (ID: setup-fe)

## Task Description
Create new React project with create-react-app, install styled-components, setup basic file structure
...
```
ESTIMATED_TURNS: 4
DELIVERABLES: package.json,src/App.js,src/index.js,.gitignore
