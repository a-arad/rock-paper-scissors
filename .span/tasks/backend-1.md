# span Task: Implement World Bank API client (ID: backend-1)

## Task Description
Create Python module to fetch GDP and fertility data using wbgapi
...
```
DELIVERABLES: wb_client.py,data_fetcher.py
