# span Task: Create UI Components (ID: ui-components)

## Task Description
Build styled game interface components with styled-components
...
ESTIMATED_TURNS: 10
DELIVERABLES: src/components/GameBoard.js,src/components/Button.js,src/components/ScoreBoard.js
```
