# span Task: Create Flask API endpoints (ID: backend-2)

## Task Description
Implement Flask routes for data retrieval and country list
...
ESTIMATED_TURNS: 6
DELIVERABLES: app.py,api_routes.py
```
