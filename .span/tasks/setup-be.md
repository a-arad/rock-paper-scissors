# span Task: Initialize Express Backend (ID: setup-be)

## Task Description
Create Express server with basic route structure and CORS setup
...
```
ESTIMATED_TURNS: 4
DELIVERABLES: server.js,package.json,routes/index.js
